...
class ShopItemFragment : Fragment() {
    ...
    private fun observeViewModel(){
        mViewModel.errorInputCount.observe(viewLifecycleOwner){
            val massage = if (it){
        ...
        mViewModel.errorInputName.observe(viewLifecycleOwner){
            val massage = if (it){
    ...
    private fun lunchEditMode() {
        ...
        mViewModel.shopItem.observe(viewLifecycleOwner){
